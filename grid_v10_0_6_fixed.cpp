// Album Art Grid v10.0.6 - Critical Crash Fix
// Fixed m_callback validity checks to prevent shutdown crashes
...
public:
    ...
    LRESULT on_paint() {
        ...
        // Get theme colors
        // v10.0.6: Check callback validity before querying colors
        ...
        // v10.0.6: Check callback validity before querying font
        HFONT hFont = NULL;
        if (m_callback.is_valid()) {
