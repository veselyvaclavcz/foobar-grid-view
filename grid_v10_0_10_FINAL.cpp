// Album Art Grid v10.0.10 - Playlist Callback Protection + F9FCh Memory Fix & Open in Folder
// CRITICAL: Added atomic destruction flags to prevent use-after-free crash at 0x1162C
// Critical memory fix for static vector cleanup crash + new context menu feature
...
DECLARE_COMPONENT_VERSION(
    ...
    "10.0.10",
    "Album Art Grid v10.0.10 - Playlist Callback Protection + F9FCh Memory Fix & Open in Folder\n"
    "CRITICAL FIXES IN v10.0.10:\n"
    "- FIXED use-after-free crash at 0x1162C in playlist callbacks\n"
    "- Added atomic destruction flags for safe callback handling\n"
...
public:
    ...
    ~album_grid_instance() {
        // Set atomic destruction flag to prevent use-after-free in callbacks
