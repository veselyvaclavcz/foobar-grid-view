// Album Art Grid v10.0.16 - Unicode Display Fix & Crash Protection
// FIXED: Unicode characters now display correctly in labels
...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.16",
    "Album Art Grid v10.0.16 - Unicode Display & Crash Fixes\n"
    "CRITICAL FIXES in v10.0.16:\n"
...
// Safe virtual call wrapper with enhanced main_thread_callback protection
template<typename Func, typename T>
T safe_virtual_call(Func&& func, T default_val) {
    if (shutdown_protection::g_is_shutting_down) return default_val;
    
    // CRASH FIX v10.0.16: Additional check for main window validity (helps prevent callback_run crashes)
    __try {
...
public:
    ...
    ~album_grid_instance() {
        ...
        console::print("[Album Art Grid v10.0.16] Closing grid instance");
