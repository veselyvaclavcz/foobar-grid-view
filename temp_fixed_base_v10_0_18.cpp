// Album Art Grid v10.0.17 - CRITICAL OBJECT VALIDATION FIX
// FIXED: Object validation BEFORE all pointer access (crash at offset 0x1208Ch)
// FIXED: Corrupted callback pointers during shutdown
// FIXED: Version string now correctly reports v10.0.17 (was showing v10.0.17)
// FIXED: Memory corruption protection with magic numbers
// FIXED: All v10.0.16 features maintained (Unicode, letter jump, etc.)
