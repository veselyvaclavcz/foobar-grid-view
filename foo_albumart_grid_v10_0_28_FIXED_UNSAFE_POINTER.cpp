// Album Art Grid v10.0.20 - COMPLETE SINGLE FILE
// SERVICE REFERENCE COUNTING FIX
...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.28",
    "Album Art Grid v10.0.28 - DESTRUCTOR SHUTDOWN GUARD\n"
    "CRITICAL FIX in v10.0.28:\n"
    "- IMPLEMENTED: Destructor shutdown detection\n"
    "- FIXED: Early exit if main window gone during shutdown\n"
    "- FIXED: Protected window destruction sequence\n"
    "- FIXED: 250ms delayed crash after proper shutdown sequence\n"
    "- NEW: Immortal callback handlers that can't cause access violations\n"
...
public:
    ...
    void draw_item(HDC hdc, Gdiplus::Graphics& graphics, HFONT font,
        ...
        if (is_now_playing) {
            ...
            int icon_size = std::min(24, m_item_size / 8);  // Smaller size, similar to badge
...
private:
    ...
    void jump_to_now_playing(bool animate = true) {
        ...
        target_scroll = std::max(0, target_scroll - viewport_height / 2 + item_total_height / 2);
