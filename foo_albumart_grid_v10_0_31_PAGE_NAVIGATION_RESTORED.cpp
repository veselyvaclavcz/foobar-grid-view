...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.31",
    "Album Art Grid v10.0.31 - PAGE NAVIGATION RESTORED\n"
    "NEW in v10.0.31:\n"
    "- RESTORED: Page Up/Down navigation using PgUp/PgDn keys\n"
    "- CONFIRMED: Letter Jump navigation (A-Z, 0-9) working\n"
    "- CONFIRMED: Full Unicode support maintained\n"
...
public:
    ...
    int calculate_text_height() {
        // v10.0.30: No static text height - using floating labels
        return 0;
    ...
    void draw_item(HDC hdc, Gdiplus::Graphics& graphics, HFONT font,
        ...
        // v10.0.30: Static text disabled - using floating labels instead
        // Draw text (multi-line support)
        if (false) { // m_config.show_text) {
