// Fixed initquit service for v10.0.17 - Object Validation Before Access
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.17 initialized - Unicode & Crash Fix");
            console::print("Available in Library menu - Press A-Z or 0-9 to jump to albums");
        } else {
            console::print("Album Art Grid v10.0.17: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
