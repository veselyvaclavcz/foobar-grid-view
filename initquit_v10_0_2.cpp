// Fixed initquit service for v10.0.2 - image loading fixes
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.2 initialized");
            console::print("Enhanced shutdown protection enabled");
        } else {
            console::print("Album Art Grid v10.0.2: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
