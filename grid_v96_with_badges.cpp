// Album Art Grid v9.6 - Track Count Badge Edition
...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "9.6.0",
    "Album Art Grid v9.6.0 - Track Count Badge Edition\n"
    "NEW: Track count badge on album art when labels are hidden!\n"
    "Features:\n"
...
VALIDATE_COMPONENT_FILENAME("foo_albumart_grid_v96.dll");
...
public:
    ...
    void draw_item(HDC hdc, Gdiplus::Graphics& graphics, HFONT font,
        ...
        // Draw track count badge when text is hidden
