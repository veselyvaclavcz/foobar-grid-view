...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.34",
    "Album Art Grid v10.0.34 - TEXT OVERLAY THEME FIX\n"
    "NEW in v10.0.34:\n"
    "- FIXED: Theme color logic - dark themes now use dark backgrounds with light text\n"
    "- FIXED: Light themes now use light backgrounds with dark text\n"
    "- PERFECT: Text overlay theme adaptation now works correctly\n"
    "MAINTAINED from v10.0.33:\n"
    "- Text overlay directly on artwork - no more layout problems with enlarged artwork\n"
    "- Grid layout preserved - enlarged artwork remains square with overlaid text\n"
...
struct grid_config {
    ...
    grid_config() : columns(5), text_lines(2), show_text(true), show_track_count(true),
                    ...
                    enlarged_now_playing(ENLARGED_NONE) {}
