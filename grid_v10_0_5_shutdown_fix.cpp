// Album Art Grid v10.0.5 - Shutdown Fix
// Fixed crash during foobar2000 shutdown with robust cleanup
...
DECLARE_COMPONENT_VERSION(
    ...
    "Album Art Grid v10.0.5 - Shutdown Fix\n"
    "FIXES IN v10.0.5:\n"
    "- Fixed crash during foobar2000 shutdown\n"
    "- Added robust shutdown handling to all components\n"
    "- Protected helpers module against shutdown access\n"
    "- Thread-safe cleanup sequence with critical sections\n"
    "From v10.0.4: All display options and crash fixes\n"
    "From v10.0.3:\n"
