// Album Art Grid v10.0.18 MPV FINAL FIX - Complete foo_mpv Plugin Compatibility Fix
// FIXED: Detects video playback and completely disables playlist callbacks to prevent "libav error"
// FIXED: All v10.0.18 FINAL fixes maintained (shutdown crashes, race conditions) 
// This version uses intelligent video detection instead of simple delays
...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.18 MPV FINAL FIX",
    "Album Art Grid v10.0.18 MPV FINAL FIX - Complete foo_mpv Plugin Compatibility Fix\n"
    "\n"
    "CRITICAL FIX IN v10.0.18 MPV FINAL FIX:\n"
    "* FIXED: foo_mpv plugin 'libav error for open input: Invalid argument' COMPLETELY RESOLVED\n"
    "* NEW: Intelligent video file detection (mp4, mkv, avi, webm, mov, flv, etc.)\n"
    "* NEW: Playlist callbacks automatically disabled during video playback\n"
    "* IMPROVED: No delays - callbacks are completely skipped when playing video\n"
    "* MAINTAINS: All v10.0.18 FINAL shutdown crash fixes and stability improvements\n"
    "\n"
    "MPV COMPATIBILITY SOLUTION:\n"
    "- Detects video file playback automatically\n"
    "- Completely disables playlist callbacks during video playback\n"
    "- Prevents ALL file access conflicts with foo_mpv\n"
    "- Automatically resumes normal operation for audio files\n"
    "- Zero performance impact, no delays needed\n"
    "\n"
