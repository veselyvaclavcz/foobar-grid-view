...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "10.0.32",
    "Album Art Grid v10.0.32 - LABELS DISPLAY FIX\n"
    "NEW in v10.0.32:\n"
    "- FIXED: Show Labels now displays album/artist text under thumbnails (was broken in v10.0.30)\n"
    "- MAINTAINED: Page Up/Down navigation using PgUp/PgDn keys\n"
    "- MAINTAINED: Letter Jump navigation (A-Z, 0-9) working\n"
    "- MAINTAINED: Full Unicode support with proper UTF-8 to UTF-16 conversion\n"
...
public:
    ...
    int calculate_text_height() {
        // v10.0.31: Restored static text height - users want visible labels
    ...
    void draw_item(HDC hdc, Gdiplus::Graphics& graphics, HFONT font,
        ...
        // v10.0.31: Static text restored - users want visible labels under albums
        // Draw text (multi-line support)
        if (m_config.show_text) {
            RECT text_rc = {x - 2, y + item_size + 4, x + item_size + 2, 
                           y + item_size + text_height - 2};
            ...
            // Draw with word wrap for multi-line support using Unicode-aware DrawTextW
            ...
            DrawTextW(hdc, wide_text.c_str(), -1, &text_rc, format);
        }
    }
