// Album Art Grid v9.5 - Artist Image Support
...
DECLARE_COMPONENT_VERSION(
    "Album Art Grid",
    "9.5.0",
    "Album Art Grid v9.5.0 - Artist Image Support\n"
    "NEW: Artist images displayed for artist-based groupings!\n"
    ...
    "Dynamic text height based on font metrics\n"
...
VALIDATE_COMPONENT_FILENAME("foo_albumart_grid_v95.dll");
