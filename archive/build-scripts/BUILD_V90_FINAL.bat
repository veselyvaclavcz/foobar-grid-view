@echo off
echo Building Album Art Grid v9.0.0 FINAL - Complete Integration...
cd /d "%~dp0"
...
echo.
echo Linking...
link /DLL /OUT:foo_albumart_grid_v90.dll ^
    grid_v8_final.obj ^
...
if exist foo_albumart_grid_v90.dll (
    echo.
    echo ========================================
    echo BUILD SUCCESSFUL!
    echo ========================================
    echo Component: foo_albumart_grid_v90.dll v9.0.0
    echo.
    echo FINAL FEATURES:
    echo - Proper edit mode with context menu pass-through
    echo - Uses foobar2000's font preferences
    echo - Auto-fill mode only
