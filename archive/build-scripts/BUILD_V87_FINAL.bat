@echo off
echo Building Album Art Grid v8.7.0 FINAL - Standard UI Element Menu...
cd /d "%~dp0"
...
echo.
echo Linking...
link /DLL /OUT:foo_albumart_grid_v87.dll ^
    grid_v8_final.obj ^
...
if exist foo_albumart_grid_v87.dll (
    echo.
    echo ========================================
    echo BUILD SUCCESSFUL!
    echo ========================================
    echo Component: foo_albumart_grid_v87.dll v8.7.0
    echo.
    echo FEATURES:
