@echo off
echo Building Album Art Grid v9.2.0 FINAL - Improved Grouping...
cd /d "%~dp0"
...
echo.
echo Linking...
link /DLL /OUT:foo_albumart_grid_v92.dll ^
    grid_v8_final.obj ^
...
if exist foo_albumart_grid_v92.dll (
    echo.
    echo ========================================
    echo BUILD SUCCESSFUL!
    echo ========================================
    echo Component: foo_albumart_grid_v92.dll v9.2.0
    echo.
    echo NEW FEATURES:
    echo - Fixed tooltip positioning (consistent below items)
    echo - Improved album grouping using titleformat
    echo - Added more grouping options:
    echo   * By Folder
    echo   * By Album
    echo   * By Artist  
    ...
    echo   * By Genre
    echo   * By Year
    echo - Better album artist handling
    echo - Dynamic text height based on font metrics
