@echo off
echo Building Album Art Grid v8.4.0 FINAL - Column Control Only...
cd /d "%~dp0"
...
echo.
echo Linking...
link /DLL /OUT:foo_albumart_grid_v84.dll ^
    grid_v8_final.obj ^
...
if exist foo_albumart_grid_v84.dll (
    echo.
    echo ========================================
    echo BUILD SUCCESSFUL!
    echo ========================================
    echo Component: foo_albumart_grid_v84.dll v8.4.0
    echo.
    echo FEATURES:
