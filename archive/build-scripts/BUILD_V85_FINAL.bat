@echo off
echo Building Album Art Grid v8.5.0 FINAL - Smart Tooltips...
cd /d "%~dp0"
...
echo.
echo Linking...
link /DLL /OUT:foo_albumart_grid_v85.dll ^
    grid_v8_final.obj ^
...
if exist foo_albumart_grid_v85.dll (
    echo.
    echo ========================================
    echo BUILD SUCCESSFUL!
    echo ========================================
    echo Component: foo_albumart_grid_v85.dll v8.5.0
    echo.
    echo FEATURES:
