@echo off
echo Building Album Art Grid v9.6.0 - Enhanced Features...
echo *****************************************************
...
if exist grid_v96_enhanced.obj del grid_v96_enhanced.obj

REM Initialize VS environment
call "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\VC\Auxiliary\Build\vcvars64.bat"

echo.
echo Compiling v9.6.0 with Track Count Badge and Themed Scrollbar...
...
REM Clean up
del grid_v96_enhanced.obj 2>nul
...
echo.
echo NEW IN v9.6 - ENHANCED FEATURES:
echo - Track count badge on album art (when labels hidden)
echo - Custom themed scrollbar using foobar2000 colors
