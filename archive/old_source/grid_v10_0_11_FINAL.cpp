// Album Art Grid v10.0.11 - ULTIMATE SHUTDOWN FIX + Performance Enhancements
...
DECLARE_COMPONENT_VERSION(
    ...
    "- Increased prefetch range (20-50 items based on RAM)\n"
    "- Increased buffer zone (50-100 items based on RAM)\n"
    "- Fixed crashes at offsets 1181Ch and 11824h during window close\n"
    "- Thread-safe instance tracking\n"
    "From v10.0.10:\n"
    "- Fixed use-after-free crash at 0x1162C in playlist callbacks\n"
...
public:
    ...
    ~album_grid_instance() {
        // CRITICAL v10.0.11: Initiate global shutdown protection
        m_is_destroying = true;
        shutdown_protection::initiate_global_shutdown();
        
        console::print("[Album Art Grid v10.0.11] Initiating safe shutdown with global protection");
    ...
    static LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp) {
        ...
        if (instance && !instance->m_is_destroying && !shutdown_protection::g_is_shutting_down) {
            switch (msg) {
                ...
                case WM_DESTROY: {
                    // Initiate global shutdown protection
                    shutdown_protection::initiate_global_shutdown();
