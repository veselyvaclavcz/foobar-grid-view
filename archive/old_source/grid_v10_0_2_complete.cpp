// Album Art Grid v10.0.2 - Image Loading Fixes
...
DECLARE_COMPONENT_VERSION(
    ...
    "Album Art Grid v10.0.2 - Image Loading Fixes\n"
    "FIXES IN v10.0.2:\n"
    "- Fixed GDI+ initialization on 64-bit systems\n"
    "- Added comprehensive error logging\n"
    "- Fixed thread safety in image loading\n"
    "- Added fallback mechanisms for failed loads\n"
    "- Improved memory stream handling\n"
    "From v10.0.1:\n"
