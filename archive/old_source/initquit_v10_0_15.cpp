// Fixed initquit service for v10.0.15 - Smart Shutdown Protection
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.15 initialized - Letter Jump Navigation");
            console::print("Available in Library menu - Press A-Z or 0-9 to jump to albums");
        } else {
            console::print("Album Art Grid v10.0.15: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
