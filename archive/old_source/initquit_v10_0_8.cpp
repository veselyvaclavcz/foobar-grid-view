// Fixed initquit service for v10.0.8 - all critical fixes applied
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.8 initialized - All critical fixes applied");
            console::print("Callback validity checks enabled at all critical points");
        } else {
            console::print("Album Art Grid v10.0.8: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
