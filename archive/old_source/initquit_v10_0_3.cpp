// Fixed initquit service for v10.0.3 - path error handling fix
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.3 initialized");
            console::print("Path error handling protection enabled");
        } else {
            console::print("Album Art Grid v10.0.3: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
