// Album Art Grid v10.0.13 - Library Viewer Integration
...
public:
    ...
    ~album_grid_instance() {
        ...
        console::print("[Album Art Grid v10.0.13] Closing grid instance");
                ...
                try {
                    ...
                    if (item->artwork.is_valid()) {
                        ...
                        if (bmp && !shutdown_protection::g_is_shutting_down) {
                            ...
                            console::print("[Album Art Grid v10.0.13] Failed to create thumbnail");
                        }
                    }
                } catch (...) {}
            } catch (...) {}
...
extern "C" {
    void set_global_shutdown_flag() {
        console::print("[Album Art Grid v10.0.13] foobar2000 is shutting down - protecting all instances");
...
void show_album_art_grid_window() {
    ...
    console::print("[Album Art Grid v10.0.13] Activated from Library menu");
