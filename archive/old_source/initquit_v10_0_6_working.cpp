// Fixed initquit service for v10.0.6 - critical crash fix
...
public:
    void on_init() override {
        ...
        if (status == Gdiplus::Ok && m_gdiplusToken != 0) {
            console::print("Album Art Grid v10.0.6 initialized - Critical crash fix applied");
            console::print("Callback validity checks and crash protection enabled");
        } else {
            console::print("Album Art Grid v10.0.6: GDI+ initialization failed");
            m_gdiplusToken = 0;
        }
    }
