@echo off
echo Creating Album Art Grid v9.6.0 Installation Package...
cd /d "%~dp0"

if not exist foo_albumart_grid_v96.dll (
    echo ERROR: foo_albumart_grid_v96.dll not found!
...
if exist foo_albumart_grid_v96.fb2k-component del foo_albumart_grid_v96.fb2k-component
...
copy foo_albumart_grid_v96.dll temp_package\

REM Create the zip file (fb2k-component is just a renamed zip)
cd temp_package
powershell -Command "Compress-Archive -Path * -DestinationPath ../foo_albumart_grid_v96.zip -Force"
cd ..

REM Rename .zip to .fb2k-component
move /y foo_albumart_grid_v96.zip foo_albumart_grid_v96.fb2k-component

REM Clean up
rmdir /s /q temp_package

if exist foo_albumart_grid_v96.fb2k-component (
    echo.
    echo ========================================
    echo PACKAGE CREATED SUCCESSFULLY!
    echo ========================================
    echo.
    echo Package: foo_albumart_grid_v96.fb2k-component
    echo.
    echo Installation instructions:
    echo 1. Open foobar2000
    echo 2. Go to File - Preferences - Components
    echo 3. Click "Install..." button
    echo 4. Select foo_albumart_grid_v96.fb2k-component
